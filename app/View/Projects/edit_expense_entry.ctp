          ...
          <div class="row"> 
            ...
            <?php echo $this->Form->create('Expense',array('class'=>'register')); ?>
              <div class="box box-primary" style="float:left; padding-bottom: 20px;">
                <div class=" col-md-12 col-sm-12 col-xs-12 " style="margin-top:20px;">
                  <?php
				echo $this->Form->input('Expense.id', array('type' => 'hidden','value'=>$this->request->data['Expense']['id'],'required'=>'required'  ));
			?>	      
			...
			?>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        ...
                        <div id="assigned_users">
                        <?php
				echo $this->Form->input('Expense.amount', array('type' => 'text','label'=>false,'div'=>false,'required'=>'required' ));
			?>
						</div>	
					</div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        ...
                        <div id="assigned_users">
                        <?php
				echo $this->Form->input('Expense.notes', array('type' => 'textarea','label'=>false,'div'=>false ));
			?>
						</div>	
					</div>
